...
## Completed Roadmap
All 21 items in TODO.roadmap/ are resolved. This directory covers
additional refactoring discovered during implementation.

## Items

| # | Title | Priority | Status |
|---|-------|----------|--------|
| 01 | [CitationGenerator strategy pattern](01-citation-strategy.md) | P1 | done |
| 02 | [useOntology purification](02-ontology-composable-purification.md) | P2 | evaluated — sufficient |
