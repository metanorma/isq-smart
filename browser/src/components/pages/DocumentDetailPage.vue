...
<template>
  <div>
    <template v-if="doc">
      ...
      >
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div class="mt-4">
            <a :href="partUrl(doc.partKey)" class="text-sm font-medium transition-colors"
      ...
      <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div v-if="docClauses.length" class="space-y-2">
          <a
            ...
            :key="clause.id"
            :href="`/documents/${doc.partKey}/sections`"
      ...
      <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
        ...
        <div v-if="docTerms.length" class="space-y-px">
          <a
            ...
            :key="term.id"
            :href="`/quantities/part-${term.partKey}/${term.id.replace('term-entry-', '')}`"
    ...
    <div v-else class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
      ...
      <a href="/documents" class="mt-6 inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-brand-600 text-white text-sm font-medium hover:bg-brand-700 transition-colors">
        Back to Documents
      </a>
    </div>
  </div>
