...
import { generateIndexJsonLd } from '../../data/serialization'
        ...
        <div class="grid lg:grid-cols-5 gap-12 lg:gap-16 items-center">
          <div class="lg:col-span-3 page-enter">
            ...
            <div class="mt-6 flex flex-wrap gap-3">
              <a href="/quantities" class="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-[#fff] text-brand-900 text-sm font-semibold hover:bg-brand-50 transition-colors shadow-lg shadow-black/10">
                Browse Quantities
              ...
              <a href="/math" class="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-white/[0.1] border border-white/[0.15] text-white text-sm font-medium hover:bg-white/[0.15] transition-colors">
                Math Notation
              </a>
              <a href="/units" class="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-white/[0.06] border border-white/[0.08] text-white/70 text-sm font-medium hover:bg-white/[0.1] hover:text-white/90 transition-colors">
                Units
              </a>
            </div>
          ...
          <div class="lg:col-span-2 page-enter" style="animation-delay: 0.1s">
            <div class="rounded-2xl bg-white/[0.06] border border-white/[0.08] backdrop-blur-sm overflow-hidden">
              ...
              <div class="flex border-t border-white/[0.06] divide-x divide-white/[0.06]">
                <a href="/quantities" class="flex-1 px-3 py-2 text-[10px] text-brand-300/50 hover:text-brand-200 transition-colors text-center">{{ quantitiesCount }} quantities</a>
                <a href="/units" class="flex-1 px-3 py-2 text-[10px] text-teal-300/50 hover:text-teal-200 transition-colors text-center">{{ totalUnits }} units</a>
                <a href="/dimensions" class="flex-1 px-3 py-2 text-[10px] text-amber-300/50 hover:text-amber-200 transition-colors text-center">{{ totalDims }} dimensions</a>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="bg-slate-50/50 dark:bg-dark-800/50 border-y border-slate-200/40 dark:border-dark-600/40">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14 scroll-reveal">
        <div class="flex items-center justify-between mb-5">
          ...
          <a href="/quantities" class="hidden sm:flex items-center gap-1.5 text-xs text-brand-600 dark:text-brand-400 hover:text-brand-700 dark:hover:text-brand-300 font-medium transition-colors">
            Browse all
        ...
        <div class="mt-6 space-y-1.5">
          ...
          <div v-for="part in mainQtyParts" :key="'dist-' + part.partKey" class="flex items-center gap-2.5 group">
            <a :href="partUrl(part.partKey)" class="w-12 text-[10px] font-mono font-semibold text-slate-500 dark:text-slate-400 group-hover:text-brand-600 dark:group-hover:text-brand-400 transition-colors text-right tabular-nums flex-shrink-0">{{ part.partKey }}</a>
    ...
    <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14 scroll-reveal">
      <div class="grid lg:grid-cols-5 gap-6 lg:gap-8">
        ...
        <div class="lg:col-span-2 space-y-4">
          ...
          <a href="/documents" class="group block rounded-2xl border border-slate-200/80 dark:border-dark-600/80 bg-white dark:bg-dark-800 p-5 hover:border-brand-200 dark:hover:border-brand-700 hover:shadow-sm transition-all">
          ...
          <a href="/ontology" class="group block rounded-2xl border border-slate-200/80 dark:border-dark-600/80 bg-white dark:bg-dark-800 p-5 hover:border-brand-200 dark:hover:border-brand-700 hover:shadow-sm transition-all">
            <div class="flex items-center gap-3 mb-2">
          ...
          <div class="rounded-2xl border border-slate-200/80 dark:border-dark-600/80 bg-white dark:bg-dark-800 p-5">
            ...
            <div class="mt-3 flex gap-2">
              <a href="/units" class="text-xs font-medium text-brand-600 dark:text-brand-400 hover:text-brand-700 dark:hover:text-brand-300 transition-colors">Browse units →</a>
              <a href="/dimensions" class="text-xs font-medium text-brand-600 dark:text-brand-400 hover:text-brand-700 dark:hover:text-brand-300 transition-colors">Dimensions →</a>
            </div>
          </div>
        </div>
      </div>
