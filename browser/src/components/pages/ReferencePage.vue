    ...
    <section class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-16">
      ...
      <div>
        <div class="flex items-center justify-between mb-4">
          ...
          <a href="/reference/urn-patterns" class="inline-flex items-center gap-1.5 text-xs text-brand-600 dark:text-brand-400 hover:text-brand-700 dark:hover:text-brand-300 font-medium transition-colors">
            Full reference
            <svg class="w-3 h-3" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" d="M9 5l7 7-7 7"/></svg>
          </a>
        </div>
