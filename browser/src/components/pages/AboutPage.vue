  ...
  <div>
    ...
    <section class="relative overflow-hidden bg-gradient-to-br from-brand-950 via-[#351a38] to-iec-900">
      ...
      <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
        <div class="max-w-3xl page-enter">
          ...
          <p class="mt-4 text-lg text-brand-200/80 heading-serif">
            The international standard for quantities, units, and mathematical notation
          </p>
          <p class="mt-3 text-sm text-brand-300/50 leading-relaxed max-w-2xl">
            Jointly published by ISO and IEC, this series defines the International System of Quantities (ISQ) — the universal language of measurement used across science, engineering, and commerce worldwide.
          </p>
        </div>
      </div>
    ...
    <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
      <div class="text-center mb-10">
        <p class="text-[10px] font-bold uppercase tracking-[0.15em] text-brand-500 mb-2">Why it exists</p>
        <h2 class="text-3xl font-bold text-slate-900 dark:text-slate-100 tracking-tight heading-serif">The Need for a Universal Standard</h2>
      </div>
      <div class="grid sm:grid-cols-2 gap-8 sm:gap-12">
        <div class="p-6 rounded-2xl bg-amber-50/50 dark:bg-amber-950/20 border border-amber-200/50 dark:border-amber-800/30">
          <div class="flex items-center gap-2.5 mb-4">
            <div class="w-9 h-9 rounded-xl bg-amber-100 dark:bg-amber-900/40 border border-amber-200/60 dark:border-amber-800/40 flex items-center justify-center">
          ...
          <p class="text-slate-600 dark:text-slate-300 leading-relaxed text-[15px]">
            Across scientific and engineering disciplines, quantities and units are expressed in many different ways. Different symbols for the same quantity, inconsistent unit choices, and varying notation habits create friction in communication, data exchange, and collaboration. Systems of quantities can be defined in multiple self-consistent ways — which treatment to adopt is partly convention.
          </p>
        </div>
        <div class="p-6 rounded-2xl bg-emerald-50/50 dark:bg-emerald-950/20 border border-emerald-200/50 dark:border-emerald-800/30">
          <div class="flex items-center gap-2.5 mb-4">
            <div class="w-9 h-9 rounded-xl bg-emerald-100 dark:bg-emerald-900/40 border border-emerald-200/60 dark:border-emerald-800/40 flex items-center justify-center">
              <svg class="w-4.5 h-4.5 text-emerald-600 dark:text-emerald-400" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
            </div>
            <h3 class="text-lg font-bold text-slate-900 dark:text-slate-100 tracking-tight heading-serif">The Standard</h3>
          </div>
          <p class="text-slate-600 dark:text-slate-300 leading-relaxed text-[15px]">
            ISO 80000 &amp; IEC 80000 codify the treatment that has become nearly universally accepted across the physical sciences — the one found in most textbooks and familiar to scientists and technologists worldwide. They provide unambiguous definitions, symbols, and units so that any measurement, equation, or specification is interpreted identically regardless of who reads it.
          </p>
        </div>
      </div>
    ...
    <section class="bg-slate-50/50 dark:bg-dark-900/30 border-y border-slate-200/50 dark:border-dark-600/50">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
        <div class="text-center mb-10">
          <p class="text-[10px] font-bold uppercase tracking-[0.15em] text-brand-500 mb-2">Overview</p>
          <h2 class="text-3xl font-bold text-slate-900 dark:text-slate-100 tracking-tight heading-serif">What It Is</h2>
        </div>
        <p class="text-slate-600 dark:text-slate-300 leading-relaxed text-[15px] max-w-3xl mx-auto text-center mb-10">
          ISO 80000 &amp; IEC 80000 are jointly developed by
          <a href="https://www.iso.org/committee/46202.html" target="_blank" rel="noopener" class="text-brand-600 dark:text-brand-400 hover:text-brand-700 dark:hover:text-brand-300 underline underline-offset-2 decoration-brand-300/50">ISO/TC&nbsp;12</a> and
          <a href="https://iec.ch/dyn/www/f?p=103:7:528830564991517::::FSP_ORG_ID,FSP_LANG_ID:1215,25" target="_blank" rel="noopener" class="text-brand-600 dark:text-brand-400 hover:text-brand-700 dark:hover:text-brand-300 underline underline-offset-2 decoration-brand-300/50">IEC/TC&nbsp;25</a> — both named "Quantities and units." The series defines the International System of Quantities (ISQ), the system of quantities underlying the International System of Units (SI). It superseded the earlier ISO&nbsp;31 and portions of IEC&nbsp;60027, harmonizing two previously separate standard families into one.
        </p>
    ...
    <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
      <div class="text-center mb-10">
        <p class="text-[10px] font-bold uppercase tracking-[0.15em] text-brand-500 mb-2">Coverage</p>
        <h2 class="text-3xl font-bold text-slate-900 dark:text-slate-100 tracking-tight heading-serif">Scope of the Series</h2>
        <p class="text-slate-500 dark:text-slate-400 text-sm max-w-2xl mx-auto mt-2">
          13 parts covering all major domains of physical science, plus mathematical notation. ISO publishes Parts 1–5, 7–12; IEC publishes Parts 6 and 13.
        </p>
      </div>

      <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-2.5 mb-6">
        <a
          v-for="p in [...qtyParts, ...mathParts]"
          :key="p.partKey"
          :href="`/quantities/part-${p.partKey}`"
      ...
      <div class="flex flex-wrap gap-3 text-xs text-slate-400 dark:text-slate-500 justify-center">
        <span class="flex items-center gap-1.5"><span class="w-2 h-2 rounded-full bg-brand-400" /> ISO-published</span>
        <span class="flex items-center gap-1.5"><span class="w-2 h-2 rounded-full bg-teal-400" /> IEC-published</span>
    ...
    <section class="bg-slate-50/50 dark:bg-dark-900/30 border-y border-slate-200/50 dark:border-dark-600/50">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-3">
          <div v-for="a in audiences" :key="a.title" class="p-5 rounded-xl bg-white dark:bg-dark-800 border border-slate-200/60 dark:border-dark-600/60 hover:border-brand-200 dark:hover:border-brand-700 hover:shadow-sm transition-all">
    ...
    <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
      <div class="text-center mb-10">
        <p class="text-[10px] font-bold uppercase tracking-[0.15em] text-brand-500 mb-2">Foundations</p>
        <h2 class="text-3xl font-bold text-slate-900 dark:text-slate-100 tracking-tight heading-serif">Key Concepts</h2>
        <p class="text-slate-500 dark:text-slate-400 text-sm max-w-2xl mx-auto mt-2">Three foundational ideas underpin the entire standard.</p>
      </div>
      <div class="grid sm:grid-cols-3 gap-6">
        <div v-for="c in concepts" :key="c.title" class="relative p-6 rounded-2xl bg-slate-50/50 dark:bg-dark-800/40 border border-slate-200/50 dark:border-dark-600/50">
          ...
          <div class="space-y-3">
            <div v-for="item in c.items" :key="item.label">
    ...
    <section class="bg-slate-50/50 dark:bg-dark-900/30 border-y border-slate-200/50 dark:border-dark-600/50">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
        <div class="text-center mb-12">
          <p class="text-[10px] font-bold uppercase tracking-[0.15em] text-brand-500 mb-2">History</p>
          <h2 class="text-3xl font-bold text-slate-900 dark:text-slate-100 tracking-tight heading-serif">Evolution</h2>
        </div>

        <div class="relative max-w-2xl mx-auto">
          <!-- Central line -->
          <div class="absolute left-[23px] top-0 bottom-0 w-px bg-slate-200 dark:bg-dark-700" />

          <div class="space-y-0">
            <div v-for="(t, i) in timeline" :key="t.year + t.label" class="relative flex gap-5" :class="i === 0 ? 'pb-6' : 'py-6'">
              <!-- Timeline dot with publisher logo -->
              <div class="relative z-10 flex-shrink-0">
                <div class="w-12 h-12 rounded-full border-2 flex items-center justify-center overflow-hidden" :class="[
                  t.highlight
                  ...
                  <img :src="publisherLogo(t.publisher)" :alt="t.publisher" class="w-6 h-6 object-contain" :class="{ 'opacity-40': t.era === 'predecessor' }" />
                </div>
              </div>

              <!-- Content -->
              <div class="flex-1 pt-1 min-w-0" :class="{ 'opacity-50': t.era === 'predecessor' }">
                <div class="flex items-center gap-2 mb-1 flex-wrap">
                  ...
                  <span v-if="t.highlight" class="text-[9px] font-bold uppercase tracking-wider px-1.5 py-0.5 rounded bg-amber-50 dark:bg-amber-950/40 text-amber-600 dark:text-amber-400">Milestone</span>
                  <span v-if="t.era === 'predecessor'" class="text-[9px] font-bold uppercase tracking-wider px-1.5 py-0.5 rounded bg-slate-100 dark:bg-dark-700 text-slate-400 dark:text-slate-500">Predecessor</span>
                  <span v-if="t.era === 'launch'" class="text-[9px] font-bold uppercase tracking-wider px-1.5 py-0.5 rounded bg-teal-50 dark:bg-teal-950/40 text-teal-600 dark:text-teal-400">Harmonization</span>
                </div>
    ...
    <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
      <div class="text-center mb-10">
        <p class="text-[10px] font-bold uppercase tracking-[0.15em] text-brand-500 mb-2">Related Work</p>
        <h2 class="text-3xl font-bold text-slate-900 dark:text-slate-100 tracking-tight heading-serif">Ecosystem</h2>
        <p class="text-slate-500 dark:text-slate-400 text-sm max-w-2xl mx-auto mt-2">Projects and standards that build on or cross-reference ISO 80000 &amp; IEC 80000.</p>
      </div>
      ...
      <a href="https://unitsml.org" target="_blank" rel="noopener" class="group block mb-8">
        <div class="relative rounded-2xl overflow-hidden border border-teal-200/60 dark:border-teal-800/40 bg-gradient-to-br from-teal-50/60 dark:from-teal-950/30 to-white dark:to-dark-900 p-6 sm:p-8 hover:shadow-lg hover:border-teal-300 dark:hover:border-teal-700 transition-all">
          <div class="absolute top-0 right-0 w-[400px] h-[400px] bg-teal-500/[0.04] dark:bg-teal-500/[0.02] rounded-full blur-[100px] -translate-y-1/2 translate-x-1/4" />
          <div class="relative flex flex-col sm:flex-row gap-6">
            ...
            <div class="min-w-0 flex-1">
              ...
              <h3 class="text-xl font-bold text-slate-900 dark:text-slate-100 group-hover:text-teal-700 dark:group-hover:text-teal-400 transition-colors heading-serif">
                <span class="sm:hidden">UnitsML &amp; UnitsDB</span>
              ...
              <div class="mt-3 flex items-center gap-2 text-xs text-teal-600 dark:text-teal-400 font-medium">
                ...
                <svg class="w-3 h-3 group-hover:translate-x-0.5 transition-transform" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" d="M9 5l7 7-7 7"/></svg>
              </div>
            </div>
          </div>
        </div>
      ...
      <!-- Supporting cards -->
      <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-3">
        <a v-for="e in ecosystem" :key="e.name" :href="e.url" target="_blank" rel="noopener" class="group p-5 rounded-xl bg-white dark:bg-dark-800 border border-slate-200/60 dark:border-dark-600/60 hover:border-brand-200 dark:hover:border-brand-700 hover:shadow-sm transition-all">
          <div class="flex items-center gap-3 mb-3">
            <div v-if="e.logo" class="w-8 h-8 rounded-lg bg-slate-50 dark:bg-dark-700 border border-slate-100 dark:border-dark-600 flex items-center justify-center flex-shrink-0">
              <img :src="e.logo" :alt="e.name" class="w-5 h-5 object-contain" />
            </div>
            <div v-else class="w-8 h-8 rounded-lg bg-slate-100 dark:bg-dark-700 border border-slate-200/60 dark:border-dark-600 flex items-center justify-center flex-shrink-0">
              <span class="text-xs font-bold text-slate-400 dark:text-slate-500">{{ e.name.charAt(0) }}</span>
            </div>
          ...
          <div class="mt-2">
            <span class="text-[9px] font-bold uppercase tracking-wider px-1.5 py-0.5 rounded" :class="accentCardBg(e.accent)">{{ e.accent === 'brand' || e.accent === 'iec' ? 'Normative' : 'Reference' }}</span>
          </div>
        </a>
      </div>
    </section>
    ...
    <section class="border-t border-slate-200/60 dark:border-dark-600/60 bg-slate-50/30 dark:bg-dark-900/30">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-center">
        ...
        <div class="flex flex-wrap justify-center gap-3">
          <a href="/quantities" class="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-brand-600 text-white text-sm font-semibold hover:bg-brand-700 transition-colors shadow-sm shadow-brand-600/25">
            Browse Quantities
          ...
          <a href="/units" class="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl border border-slate-200 dark:border-dark-600 bg-white dark:bg-dark-800 text-slate-700 dark:text-slate-200 text-sm font-medium hover:border-brand-200 dark:hover:border-brand-700 transition-colors">
            Units
          </a>
          <a href="/dimensions" class="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl border border-slate-200 dark:border-dark-600 bg-white dark:bg-dark-800 text-slate-700 dark:text-slate-200 text-sm font-medium hover:border-brand-200 dark:hover:border-brand-700 transition-colors">
            Dimensions
          </a>
