  ...
  <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          ...
          <div class="flex gap-6">
            ...
            <div v-if="importedOntologies.length">
              ...
              <div class="flex gap-1.5 mt-0.5">
                <a v-for="imp in importedOntologies" :key="imp.prefix"
                  :href="`/ontology/${allEntities.find(e => e.type === 'ontology' && e.ontology === imp.prefix)?.slug}`"
    ...
    <div v-if="section === 'namespaces'" class="mt-8 space-y-4">
      <div v-for="ns in namespaceGroups" :key="ns.prefix" class="rounded-2xl border border-slate-200/80 dark:border-dark-600/80 bg-white dark:bg-dark-800 p-6">
        ...
        <div class="flex flex-wrap gap-1.5">
          <a v-for="e in ns.entities" :key="e.qname" :href="`/ontology/${e.slug}`"
    ...
    <div v-if="section === 'az'" class="mt-8 space-y-6">
      <div class="rounded-2xl border border-slate-200/80 dark:border-dark-600/80 bg-white dark:bg-dark-800 p-6">
        ...
        <div class="flex flex-wrap gap-1.5">
          <a v-for="e in [...allEntities].sort((a, b) => a.label.localeCompare(b.label))"
            :key="e.qname"
        ...
        <table class="w-full text-sm">
          ...
          <tbody>
            <tr v-for="c in classes" :key="c.qname" class="border-b border-slate-100/60 last:border-0 hover:bg-slate-50/50 dark:hover:bg-dark-700/50">
              ...
              <td class="px-4 py-2">
                <a v-if="c.parent" :href="`/ontology/${allEntities.find(e => e.qname === c.parent)?.slug}`" class="text-blue-600 hover:underline text-xs">{{ c.parent }}</a>
    ...
    <div v-if="section === 'properties'" class="mt-8 space-y-4">
      ...
      <div class="rounded-2xl border border-slate-200/80 dark:border-dark-600/80 bg-white dark:bg-dark-800 p-6">
        ...
        <div class="flex flex-wrap gap-1.5">
          <a v-for="p in annProps" :key="p.qname" :href="`/ontology/${p.slug}`"
    ...
    <div v-if="section === 'shapes'" class="mt-8 space-y-4">
      <div v-for="s in shapes" :key="s.qname" class="rounded-2xl border border-slate-200/80 dark:border-dark-600/80 bg-white dark:bg-dark-800 p-6">
        ...
        <div class="text-xs text-slate-500 mb-3">
          <span v-if="s.targetClass">Target: <a :href="`/ontology/${allEntities.find(e => e.qname === s.targetClass)?.slug}`" class="text-blue-600 hover:underline">{{ s.targetClass }}</a></span>
          <span v-if="s.targetSubjectsOf">Subjects of: <a :href="`/ontology/${allEntities.find(e => e.qname === s.targetSubjectsOf)?.slug}`" class="text-blue-600 hover:underline">{{ s.targetSubjectsOf }}</a></span>
          ...
          <table class="w-full text-xs">
            ...
            <tbody>
              <tr v-for="(c, i) in s.constraints" :key="i" class="border-b border-slate-100/60 last:border-0">
                <td class="px-3 py-2">
                  <a v-if="allEntities.find(e => e.qname === c.path)" :href="`/ontology/${allEntities.find(e => e.qname === c.path)!.slug}`" class="text-blue-600 hover:underline">{{ c.path }}</a>
                ...
                <td class="px-3 py-2">
                  ...
                  <a v-else-if="c.classValue" :href="`/ontology/${allEntities.find(e => e.qname === c.classValue)?.slug}`" class="text-blue-600 hover:underline">{{ c.classValue }}</a>
