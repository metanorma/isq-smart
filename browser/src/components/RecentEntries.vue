...
<template>
  <section v-if="recent.length" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 scroll-reveal">
    <div class="flex items-center gap-2 mb-3">
      ...
      <span class="text-xs font-semibold text-slate-400 uppercase tracking-[0.15em]">Recently Viewed</span>
    </div>
    <div class="flex flex-wrap gap-2">
      ...
      >
        <span class="font-mono text-xs text-brand-600 bg-brand-50 px-1.5 py-0.5 rounded">{{ r.num }}</span>
