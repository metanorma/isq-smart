          ...
          <div class="flex items-start gap-4">
            ...
            <div class="min-w-0">
              ...
              <div class="mt-2 flex flex-wrap items-center gap-2 text-xs">
                ...
                <router-link :to="`/documents/part-${part.toString().split('-')[0]}`" class="text-brand-600 dark:text-brand-400 hover:text-brand-700 dark:hover:text-brand-300 font-medium transition-colors">&rarr; About {{ meta.parentPart ? `Part ${meta.parentPart}` : 'this part' }}</router-link>
              </div>
            </div>
          </div>
