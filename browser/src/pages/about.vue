    ...
    <section class="border-t border-slate-200/60 dark:border-dark-600/60 bg-slate-50/30 dark:bg-dark-900/30">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-center">
        ...
        <div class="flex flex-wrap justify-center gap-3">
          <router-link to="/quantities" class="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-brand-600 text-white text-sm font-semibold hover:bg-brand-700 transition-colors shadow-sm shadow-brand-600/25">
            Browse Quantities
          ...
          <router-link to="/units" class="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl border border-slate-200 dark:border-dark-600 bg-white dark:bg-dark-800 text-slate-700 dark:text-slate-200 text-sm font-medium hover:border-brand-200 dark:hover:border-brand-700 transition-colors">
            Units
          </router-link>
          <router-link to="/dimensions" class="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl border border-slate-200 dark:border-dark-600 bg-white dark:bg-dark-800 text-slate-700 dark:text-slate-200 text-sm font-medium hover:border-brand-200 dark:hover:border-brand-700 transition-colors">
            Dimensions
          </router-link>
